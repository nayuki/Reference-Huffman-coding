...
public final class FrequencyTable {
     ...
     */
    public FrequencyTable(int[] frequency) {
        Objects.requireNonNull(frequency);
        if (frequency.length < VIRTUAL_VALUE) {
            throw new IllegalArgumentException("At least 2 symbols needed");
        }
        // Defensive copy
        frequencies = frequency.clone();
     ...
     *
     * hattoemi:这个方法似乎没有被用过(This method does not seem to have been used)
     *
