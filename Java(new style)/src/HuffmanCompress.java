...
public final class HuffmanCompress {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FrequencyTable frequency = getFrequencies(inputFile);
        // EOF symbol gets a frequency of 1
        frequency.increment(256);
        CodeTree code = frequency.buildCodeTree();
        CanonicalCode canonCode = new CanonicalCode(code, frequency.getSymbolLimit());
    ...
    private static FrequencyTable getFrequencies(File file) throws IOException {
        FrequencyTable frequency = new FrequencyTable(new int[257]);
